"""
Custom filters for Jinja2 defined inside
["OPTIONS"]["filters"] dict key setting.
"""
from re import sub
...
def remove_accent(word):
    ...
    (ά, ί etc) are transformed via CSS to uppercase letters but the accent
    remains making it look ugly (ΚΑΛΗΜΈΡΑ instead of ΚΑΛΗΜΕΡΑ).
